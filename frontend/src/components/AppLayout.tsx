...
import {
  MenuOutlined, DashboardOutlined, ThunderboltOutlined, UserOutlined, AimOutlined, LogoutOutlined, BarChartOutlined, TeamOutlined, MessageOutlined, SettingOutlined
